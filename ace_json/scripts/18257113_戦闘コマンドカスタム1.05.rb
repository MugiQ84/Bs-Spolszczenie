...
class Window_ActorCommand < Window_Command
  ...
  def add_CW_party_command
    ...
    unless $cwinter_script_battle_formation
      ...
      text  = "Błąd: Niestandardowe polecenia bitwy\nn"

      text += "Skrypt bazowy CW Party Formation nie jest zainstalowany\nn"

      text += "Czy zainstalować skrypt bazowy CW Party Formation?\n"

      text += "Usuń :CW_party z ustawień ACTOR_COMMAND_LIST"
  ...
  def add_DA_party_command
    ...
    unless BattleCommand_Custom.ex_DA_party?
      ...
      text += "Skrypt rozszerzający DA Actor Command PT Formation nie jest zainstalowany\nn"

      text += "Czy zainstalować skrypt DA Actor Command PT Formation?\n"

      text += "Usuń :DA_party z ustawień ACTOR_COMMAND_LIST"
