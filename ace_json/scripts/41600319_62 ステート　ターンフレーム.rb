...
class Game_Battler < Game_BattlerBase
  ...
  def state_regenerate_message_set(id)
    ...
    when 0; return  "%s regeneruje %s HP!"

    when 1; return  "%s otrzymuje %s obrażeń HP!"

    when 2; return  "%s regeneruje %s MP!"

    when 3; return  "%s otrzymuje %s obrażeń MP!"

    when 4; return  "%s regeneruje %s TP!"

    when 5; return  "%s otrzymuje %s obrażeń TP!"
