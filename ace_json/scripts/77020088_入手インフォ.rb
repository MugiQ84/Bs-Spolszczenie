...
module CUSTOM_GET_WINDOW
  ...
  GOLD_TEXT_ADD      = "Dusza zdobyta!"      #お金を入手した際の表示テキスト

  GOLD_TEXT_REMOVE   = "Dusza utracona..."      #お金を消失した際の表示テキスト

  ITEM_TEXT_ADD      = "Przedmiot zdobyty!"  #アイテムを入手した際の表示テキスト

  ITEM_TEXT_REMOVE   = "Przedmiot utracony..."  #アイテムを消失した際の表示テキスト

  WEAPON_TEXT_ADD    = "Broń zdobyta!"      #武器を入手した際の表示テキスト

  WEAPON_TEXT_REMOVE = "Broń utracona..."      #武器を消失した際の表示テキスト

  ARMOR_TEXT_ADD     = "Pancerz zdobyty!"      #防具を入手した際の表示テキスト

  ARMOR_TEXT_REMOVE  = "Pancerz utracony..."      #防具を消失した際の表示テキスト

  SKILL_TEXT_ADD     = "Umiejętność opanowana!"    #スキルを習得した際の表示テキスト

  SKILL_TEXT_REMOVE  = "Umiejętność zapomniana..."    #スキルを忘れた際の表示テキスト

  EXP_TEXT_ADD       = "EXP zdobyte!"       #EXPを入手した際の表示テキスト

  EXP_TEXT_REMOVE    = "EXP utracone..."       #EXPを消失した際の表示テキスト
...
class Window_Getinfo < Window_Base
  ...
  def refresh(id, type, text = "", value)
    ...
    else   ; p "Nieprawidłowa wartość type><;"
